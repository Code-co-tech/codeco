            ...
            <div className="container">
                <div className="heading_block text-center">
                    <div className="heading_focus_text">
                        Наша
                        <span className="badge bg-secondary text-white">Cпециализация</span>
                    </div>
                            ...
                            {service.title ?
                                <div className="service_block">
                                    <div className="service_image">
                                        <img src={service.sImg} alt="Услуги управления IT" />
                                    </div>
                ...
                <div className="btns_group pb-0">
                    <Link onClick={ClickHandler} className="btn btn-outline-light" to="/service">
                        <span className="btn_label" data-text="Дополнительные услуги">Дополнительные услуги</span>
